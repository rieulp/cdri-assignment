...
export function SearchInput({
  ...
  return (
    ...
    >
      ...
      />
      {showHistories && (
        <SearchHistory histories={searchHistories} onRemoveHistory={onHistoryRemove} onSelectHistory={handleSubmit} />
      )}
    </form>
  );
}

function SearchField(props: Omit<ComponentProps<typeof Input>, 'autoComplete' | 'className'>) {
  {
    return (
